                        ...
                        $hoy = date('Y-m-d');
                         ...
                         $query = mysqli_query($conexion, "SELECT * FROM ninos WHERE fecha_cita >='$hoy' " );
                            ...
                            if ($result > 0) {
                                 ...
                                 <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#atencion<?php echo $data['idninos']; ?>"><i class='fas fa-edit'></i>
                         </button>
                                     ...
                                     <?php  include('EditarAtenPDNJ.php'); ?>
                             <?php }
                            } ?>
                    </tbody>
