...
foreach ($query as $servicios) {
    ...
    foreach ($resultado_servicios as $form_section) {
        ...
        if ($form_section['categoria'] == 'HEMATOLOGIA') {
            // TEST PASSED
            require_once './laboratorio/hematologia.php';
            require_once './laboratorio/formula_leucocitaria.php';
        } elseif ($form_section['categoria'] == 'RETICULOCITOS') {
            require_once './laboratorio/reticulocitos.php';
        } elseif ($form_section['categoria'] == 'TIEMPOS') {
            // TEST PASSED
            require_once './laboratorio/perfil_de_coagulacion.php';
        } elseif ($form_section['categoria'] == 'PRUEBA ESPECIAL') {
            require_once './laboratorio/prueba_especial.php';
        } elseif ($form_section['categoria'] == 'QUIMICA') {
            require_once './laboratorio/quimica.php';
        } elseif ($form_section['categoria'] == 'ORINA') {
            // TEST PASSED
            require_once './laboratorio/examen_orina.php';
            require_once './laboratorio/examen_orina_microscopio.php';
        } elseif ($form_section['categoria'] == 'HECES') {
            require_once './laboratorio/examen_heces.php';
                                    ?>
                                        <div class="card">
                                            <div class="card-header bg-primary text-white text-center">
                                                EXAMEN DE HECES
