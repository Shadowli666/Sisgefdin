                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <a href="DescargarReporte_x_fecha_itinerarios.php?from_date=<?php echo isset($_GET['from_date']) ? $_GET['from_date'] : ''; ?>&to_date=<?php echo isset($_GET['to_date']) ? $_GET['to_date'] : ''; ?>" class="btn btn-success"><i class='fas fa-file-excel'></i> Descargar Excel</a>
                            </div>
                        </div>
                    </div>
                    <br>
                        ...
                        <tbody>
                            ...
                            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
                                ...
                                $query = "SELECT itinerario.idcita, itinerario.id_cliente, cliente.idcliente, cliente.cedula, cliente.nombre, cliente.apellido, cliente.edad, cliente.telefono, itinerario.especialidad, itinerario.descripcion,
                                    itinerario.precios, itinerario.fecha, itinerario.atencion, itinerario.observacion FROM itinerario INNER JOIN cliente ON cliente.idcliente = itinerario.id_cliente WHERE itinerario.fecha BETWEEN '$from_date' AND '$to_date' ";
                ...
                var tabla = $("#tabla").DataTable({
                    ...
                    "drawCallback": function() {
                        ...
                        $(api.column(0).footer()).html(
                            'Total $: ' + api.column(5, {
                                page: 'current'
                            }).data().sum().toLocaleString(undefined, {
