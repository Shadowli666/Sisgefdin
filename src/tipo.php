                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-group">
                                <label for="nombre" class="text-dark font-weight-bold">Principio Activo</label>
                                <input type="text" placeholder="Ingrese Principio Activo" name="nombre" id="nombre" class="form-control">
