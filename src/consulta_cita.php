                            ...
                            if ($result > 0) {
                                 while ($data = mysqli_fetch_array($query)) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $data['precios']; ?></td>
                                        <td><?php echo $data['fecha']; ?></td>
                                        <td><?php echo $data['atencion']; ?></td>
                                        <td><?php echo $data['observacion']; ?></td>
                                        <td> 
                         <button type="button" class="btn-sm btn-primary" data-toggle="modal" data-target="#editChildresn<?php echo $data['idcita']; ?>"><i class='fas fa-edit'></i>
                         </button>
